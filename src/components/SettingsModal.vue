    ...
    <div class="van-content">
      <div class="van-content-top">
        ...
        <div class="van-content-top-tab">
          <van-button :type="gasPrice == 100000000000 ? 'primary' : 'info'" class="gasPrice" @click="handlePrice(100000000000)">{{ $t('lang.swap42') }}(100)</van-button>
          <van-button :type="gasPrice == 120000000000 ? 'primary' : 'info'" class="gasPrice" @click="handlePrice(120000000000)">{{ $t('lang.swap43') }}(120)</van-button>
          <van-button :type="gasPrice == 150000000000 ? 'primary' : 'info'" class="gasPrice" @click="handlePrice(150000000000)">{{ $t('lang.swap44') }}(150)</van-button>
        </div>
      </div>
